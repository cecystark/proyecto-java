...
public class Home extends JFrame {
	...
	public Home() {
		...
		btn_ingresar.setBackground(new Color(241, 57, 83));
		btn_ingresar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
//				Controlador controlador= new Controlador();
		
//				controlador.validarIngreso(textUsuario.getText(), textContrasenia.getText());				
		}});
		
		btn_ingresar.setBounds(582, 406, 225, 62);
