...
import service.ServicioGestionDeBaja;
...
public class BajaFrame extends JFrame {
		...
		buttonDarBaja.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(textoprod.isEmpty() && textocod.isEmpty())
					...
					ServicioGestionDeBaja datos = new ServicioGestionDeBaja();
						if (textocod.isEmpty())
							datos.gestionarBaja(textoprod);
						else
							datos.gestionarBaja(Integer.parseInt(textocod));
